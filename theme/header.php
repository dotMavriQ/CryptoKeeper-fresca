...
<body <?php body_class(); ?>>
	...
	<div id="page" <?php /* class="min-h-screen flex flex-col" */ ?>>
		...
		<!-- 				<nav id="site-navigation" class="main-navigation">
					<button
						class="menu-toggle md:hidden text-white focus:outline-none focus:text-gray-300 hover:text-gray-300 the-peps"
